...
namespace test.Controllers
{
    public class FansClubController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,PrivateName,LastName,IsFemale,BirthDate,Seniority")] Fan fan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PrivateName,LastName,IsFemale,BirthDate,Seniority")] Fan fan)
        {
            if (ModelState.IsValid)
            {
